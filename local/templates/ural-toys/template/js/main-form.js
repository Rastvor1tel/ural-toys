...
(function () {
  ...
  const MIN_VALUE = document.querySelector('.jsMinPrice') ? parseInt(document.querySelector('.jsMinPrice').innerHTML) : 0;
  const MAX_VALUE = document.querySelector('.jsMaxPrice') ? parseInt(document.querySelector('.jsMaxPrice').innerHTML) : 0;
