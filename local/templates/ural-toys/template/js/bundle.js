...
(function () {
  var parseGridRow = function parseGridRow(parseItem, templateString) {
    var getAllItems = document.querySelectorAll(parseItem);
    var mobileGridElement = 'catalog-grid__item-is-mobile';
    var checkBreakPoint = false;
    getAllItems.forEach(function (item, index) {
...
(function () {
  ...
  var brandsSLider = new Swiper('.single-column-slider__wrap', {
    slidesPerView: 10,
    spaceBetween: 74,
    breakpoints: {
      1440: {
...
(function () {
  var itemsSlider = new Swiper('.items-slider__wrap', {
    slidesPerColumn: 2,
    spaceBetween: 20,
    slidesPerView: 8,
    watchOverflow: true,
...
(function () {
  /*
     ...
     */
  var slider = document.getElementById('form-range');
  var sliderMin = document.getElementById('input-min');
  var sliderMax = document.getElementById('input-max');
  var sliderValues = [sliderMin, sliderMax];
  var MIN_VALUE = parseInt(document.querySelector('.jsMinPrice').innerHTML);
  var MAX_VALUE = parseInt(document.querySelector('.jsMaxPrice').innerHTML);
...
var init = function init(points, divId) {
  ymaps.ready(function () {
    ...
    var _loop = function _loop(i) {
      var point = points[i]; // Создаем балуны для каждой точки

      var createBalloonContent = function createBalloonContent() {
        // Заголовок
        var summaryHTML = '<div class="map__balloonHeader">' + point.name + '</div>'; // Телефон
        ...
        summaryHTML += '<div class="map__balloonAddress map__balloonAddress_storage"><b>Адрес склада: </b>' + point.addressStorage + '</div>'; // Адрес офиса
