                            ...
                            <div class="header-mobile__subwrap">
                                ...
                                <div class="header-mobile__manager">
                                    ...
                                    <p class="header-mobile__prop">
                                        <span class="header-mobile__text">Телефон:</span><span
                                                class="header-mobile__value">+7 (343) 270-22-02 (доб.207)</span>
                                    </p>
                                    <p class="header-mobile__prop">
                                    ...
                                    <p class="header-mobile__prop">
                                        <span class="header-mobile__text">E-mail:</span><span
                                                class="header-mobile__value">anna_k@ural-toys.ru</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="header__middle-right">
                        <div class="header__middle-top">
                            <div class="header__search search">
                                <form action="">
                                    <label class="search__label js-fixedLabel">
                                        ...
                                        <div class="header__hidden-scroll">
                                            ...
                                            <div class="header__hidden-items header-items">
                                                <div class="header-items__elem js-elemItem">
                                                    ...
                                                    <button type="button"
                                                            class="header-items__elem-delete js-removeItem">
                                                        <svg>
